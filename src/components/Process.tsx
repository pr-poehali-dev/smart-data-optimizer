...
const steps = [
  {
    ...
    title: "Заявка",
    description:
      "Оставляете заявку или звоните нам. Уточняем задачи, площадь кухни, технологические процессы и бюджет.",
  },
  {
    number: "02",
    title: "Подбор",
    description:
      "Подбираем оптимальное оборудование под ваши задачи, готовим коммерческое предложение и спецификацию.",
  },
  {
    number: "03",
    title: "Поставка и монтаж",
    description:
      "Доставляем оборудование, выполняем монтаж и пусконаладку. Обучаем персонал работе с техникой.",
  },
  {
    number: "04",
    title: "Сервис",
    description:
      "Обеспечиваем гарантийное и постгарантийное обслуживание, поставку запчастей и расходных материалов.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Просто
                <span className="italic"> и удобно</span>
              </h2>
              <p
              ...
              >
                Мы сопровождаем вас на каждом этапе — от подбора оборудования до запуска кухни и
                дальнейшего сервиса. Берём все технические вопросы на себя.
              </p>
            </div>
          </div>
