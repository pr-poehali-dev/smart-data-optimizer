  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Оборудование,
          <span className="block text-sage">на которое можно положиться</span>
        </h1>
        ...
        >
          Профессиональное тепловое, холодильное и технологическое оборудование для ресторанов, кафе и пищевых производств. Поставка, монтаж и сервис.
        </p>
