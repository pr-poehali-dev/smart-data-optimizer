...
const services = [
  {
    ...
    description: "Плиты, пароконвектоматы, жарочные поверхности, фритюрницы и грили для профессиональной кухни.",
    icon: "Flame",
  },
  {
    title: "Холодильное оборудование",
    description: "Шкафы, столы, лари и витрины для хранения продуктов с соблюдением всех температурных норм.",
    icon: "Snowflake",
  },
  {
    title: "Технологическое оборудование",
    description: "Мясорубки, тестомесы, овощерезки, слайсеры и миксеры для пищевых цехов и производств.",
    icon: "Cog",
  },
  {
    title: "Нейтральное оборудование",
    description: "Производственные столы, стеллажи, мойки и полки из нержавеющей стали для любой кухни.",
    icon: "LayoutGrid",
  },
]
